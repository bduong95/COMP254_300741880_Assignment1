...
public class CircularlyLinkedList<E> {
  ...
  public CircularlyLinkedList<E> cloneList() {
	  // Create the cloned list to return
	  CircularlyLinkedList<E> clone = new CircularlyLinkedList<E>();
	  
	  // Create node to traverse the list. Set to the head of the CLL
	  ...
	  while (walk != tail.getNext()); // Keep going until the head of the CLL is reached again
...
//main method
  public static void main(String[] args)
  {
	  ...
	  // Testing the cloning function for CLL
	  System.out.println("Cloning below here...");
	  
	  // Creating list and populating it with values
	  CircularlyLinkedList<String> list1 = new CircularlyLinkedList<String>();
	  list1.addFirst("Raptors");
	  list1.addLast("Tank");
	  list1.addLast("2024");
	  
	  // Cloning list1 and displaying output
	  CircularlyLinkedList<String> clone1 = list1.cloneList();
	  System.out.println(list1);
	  clone1.rotate();
	  clone1.addFirst("Toronto");
	  System.out.println(clone1);
	  
	  // Show that the original list (clone1) has not changed
	  System.out.println(list1);
	  //
  }
}
